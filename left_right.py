...
# Movement sequence tracking - only keeps last 4 states
...
def check_movement_completion():
    # Only check when we have exactly 4 elements
    ...
    if seq == ("RIGHT", "NEUTRAL", "LEFT", "NEUTRAL"):
        print("RIGHT SUCCESS")
        movement_sequence.clear()  # Clear the buffer completely
        return True
    ...
    # If we have 4 elements but no match, clear the oldest one
